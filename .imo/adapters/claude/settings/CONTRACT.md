...
- Trellis-owned settings stay outside IMO manifests. Future settings-related
  IMO behavior must use namespaced non-overlapping blocks or explicit
  non-conflicting registration points; same-path settings takeover is
