...
<!--
  ...
  Auto-generated by hooks/metrics/gen_svg.py
  Source of truth: metrics/events/, metrics/daily/
  Regenerate: python3 ~/.claude/hooks/metrics/gen_svg.py
  Manual edits will be overwritten on next regenerate.
-->"""
